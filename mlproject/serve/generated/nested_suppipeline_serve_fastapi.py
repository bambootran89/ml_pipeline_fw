# Auto-generated FastAPI serve for nested_suppipeline_serve
...
app = FastAPI(
    title="nested_suppipeline_serve API",
    version="1.0.0",
...
class ServeService:
    ...
    FEATURE_GENERATORS = {
        "cluster_1_features": {
            "model_key": "fitted_cluster_type_1",
            "artifact_name": "cluster_type_1",
            "inference_method": "predict",
            "step_type": "inference"},
        "pca_data": {
            "model_key": "fitted_pca",
            "artifact_name": "pca",
            "inference_method": "transform",
            "step_type": "dynamic_adapter"}}
    ...
    def __init__(self, config_path: str) -> None:
        ...
        if self.mlflow_manager.enabled:
            ...
            print(
                f"[ModelService] Loading model: fitted_train_model from "
                f"train_model (alias: latest)..."
            )
            component = self.mlflow_manager.load_component(
    ...
    def predict_tabular_batch(
        ...
        if model is not None:
            ...
            # train_model_inference: merge features
