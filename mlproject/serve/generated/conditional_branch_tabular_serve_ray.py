...
class ModelService:
    ...
    def _check_feast(self) -> None:
        if "mlproject/data/titanic.csv".startswith("feast://"):
    ...
    def _load_models(self) -> None:
        ...
        print(
            f"[ModelService] Loading model: fitted_train_tab_catboost "
            f"(alias: latest)..."
        )
        component = self.mlflow_manager.load_component(
        ...
        print(
            f"[ModelService] Loading model: fitted_train_tab_xgboost "
            f"(alias: latest)..."
        )
        component = self.mlflow_manager.load_component(
...
class ServeAPI:
    ...
    def __init__(self, preprocess_handle: Any, model_handle: Any) -> None:
        ...
        self.cfg = ConfigLoader.load("mlproject/configs/experiments/tabular.yaml")
...
def app_builder(args: Dict[str, str]) -> Any:
    config_path = args.get("config", "mlproject/configs/experiments/tabular.yaml")
