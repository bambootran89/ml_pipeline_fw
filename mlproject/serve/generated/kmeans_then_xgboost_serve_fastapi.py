# Auto-generated FastAPI serve for kmeans_then_xgboost_serve
...
app = FastAPI(
    title="kmeans_then_xgboost_serve API",
    version="1.0.0",
...
class ServeService:
    ...
    def __init__(self, config_path: str) -> None:
        ...
        if self.mlflow_manager.enabled:
            ...
            print(
                f"[ModelService] Loading model: fitted_kmeans_features from "
                f"kmeans_features (alias: latest)..."
            )
            component = self.mlflow_manager.load_component(
            ...
            if component is not None:
                self.models["fitted_kmeans_features"] = component
    ...
    def predict_tabular_batch(
        ...
        model = self.models.get("fitted_kmeans_features")
        if model is not None:
            ...
            if x is not None:
                ...
                p = model.predict(inp)
                results["kmeans_features_predictions"] = p.tolist()
                context["kmeans_features_predictions"] = p
                if return_probabilities and hasattr(model, "predict_proba"):
                    try:
                        pb = model.predict_proba(inp)
                        results["kmeans_features_predictions_probabilities"] = (
                            pb.tolist()
                        )
                    except Exception:
                        pass
    ...
    def predict_timeseries_multistep(
        ...
        if model is not None:
            ...
            if feat is not None:
                ...
                results["kmeans_features_predictions"] = out.tolist()
                context["kmeans_features_predictions"] = out
