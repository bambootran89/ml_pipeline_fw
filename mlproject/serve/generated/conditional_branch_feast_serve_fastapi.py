# Auto-generated FastAPI serve for conditional_branch_feast_serve
...
app = FastAPI(
    title="conditional_branch_feast_serve API",
    version="1.0.0",
...
class ServeService:
    ...
    def __init__(self, config_path: str) -> None:
        ...
        if self.mlflow_manager.enabled:
            ...
            print(
                f"[ModelService] Loading model: fitted_train_xgb from "
                f"train_xgb (alias: latest)..."
            )
            component = self.mlflow_manager.load_component(
            ...
            print(
                f"[ModelService] Loading model: fitted_train_tft from "
                f"train_tft (alias: latest)..."
            )
            component = self.mlflow_manager.load_component(
...
service = ServeService("mlproject/configs/experiments/etth1_feast.yaml")
