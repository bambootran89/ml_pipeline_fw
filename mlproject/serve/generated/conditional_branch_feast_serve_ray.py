...
class ModelService:
    ...
    def _check_feast(self) -> None:
        if "feast://feature_repo_etth1?entity=location_id&id=1".startswith("feast://"):
    ...
    def _load_models(self) -> None:
        ...
        print(
            f"[ModelService] Loading model: fitted_train_tft "
            f"(alias: latest)..."
        )
        component = self.mlflow_manager.load_component(
        ...
        if component is not None:
            self.models["fitted_train_tft"] = component
        print(
            f"[ModelService] Loading model: fitted_train_xgb "
            f"(alias: latest)..."
        )
        component = self.mlflow_manager.load_component(
        ...
        if component is not None:
            self.models["fitted_train_xgb"] = component
    ...
    def predict_tabular_batch(
        ...
        model = self.models.get("fitted_train_tft")
        if model is not None:
            ...
            if x is not None:
                ...
                p = model.predict(inp)
                results["train_tft_predictions"] = p.tolist()
                context["train_tft_predictions"] = p
                if return_probabilities and hasattr(model, "predict_proba"):
                    try:
                        pb = model.predict_proba(inp)
                        results["train_tft_predictions_probabilities"] = (
                            pb.tolist()
                        )
                    except Exception:
                        pass

        model = self.models.get("fitted_train_xgb")
        if model is not None:
            ...
            if x is not None:
                ...
                metadata["n_samples"] = len(inp)
                p = model.predict(inp)
                results["train_xgb_predictions"] = p.tolist()
                context["train_xgb_predictions"] = p
                if return_probabilities and hasattr(model, "predict_proba"):
                    try:
                        pb = model.predict_proba(inp)
                        results["train_xgb_predictions_probabilities"] = (
                            pb.tolist()
                        )
                    except Exception:
                        pass
    ...
    def predict_timeseries_multistep(
        ...
        if model is not None:
            ...
            if feat is not None:
                ...
                results["train_tft_predictions"] = out.tolist()
                context["train_tft_predictions"] = out
        ...
        if model is not None:
            ...
            if feat is not None:
                ...
                results["train_xgb_predictions"] = out.tolist()
                context["train_xgb_predictions"] = out
...
class ServeAPI:
    ...
    def __init__(self, preprocess_handle: Any, model_handle: Any) -> None:
        ...
        self.cfg = ConfigLoader.load("mlproject/configs/experiments/etth1_feast.yaml")
...
def app_builder(args: Dict[str, str]) -> Any:
    config_path = args.get("config", "mlproject/configs/experiments/etth1_feast.yaml")
...
if __name__ == "__main__":
    serve.start(http_options={"host": "0.0.0.0", "port": 8082})
